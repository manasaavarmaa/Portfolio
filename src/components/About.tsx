...
a focus on Artificial Intelligence and Machine Learning.I have gained hands-on experience
 ...
 and data analysis. I am passionate about building scalable AI solutions and intuitive web applications. Actively involved in technical 
 communities and study jams, I continuously seek to expand my knowledge and contribute to impactful tech
  initiatives.   
</p>
            <p className="text-lg text-muted-foreground leading-relaxed text-justify">
